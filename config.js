...
module.exports = {
    ...
    ANTI_SPAM: process.env.ANTI_SPAM || '263784562833-1632403322@g.us',
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~2a993ee222c91a1f98ae1adf647bd6a7:787036786d42586b525a453d').trim() || '',
    ...
    STICKER_DATA: process.env.STICKER_DATA || "𝑺𝑻𝑹𝑰𝑲𝑬𝑹𝑩𝑶𝒀 𝑩𝑶𝑻",
    BOT_NAME: process.env.BOT_NAME || '𝑺𝑻𝑹𝑰𝑲𝑬𝑹𝑩𝑶𝒀 🅜︎🅤︎🅢︎🅘︎🅒︎ ᵇᵒᵗ',
    ...
    SUDO: process.env.SUDO || "263719765023,263784562833",
